...
ant -Dsource=human-gene-info -v
ant -Dsource=mouse-gene-info -v
ant -Dsource=rat-gene-info -v
ant -Dsource=pig-gene-info -v
...
ant -Dsource=bovine-UMD3.1.1-coding-gff -v
ant -Dsource=bovine-UMD3.1.1-noncoding-gff -v
ant -Dsource=bovine-ARS-UCD1.2-coding-gff -v
ant -Dsource=bovine-ARS-UCD1.2-noncoding-gff -v

ant -Dsource=chir-coding-gff -v
ant -Dsource=chir-noncoding-gff -v
ant -Dsource=oari-Oar-v3.1-coding-gff -v
ant -Dsource=oari-Oar-v4.0-coding-gff -v
ant -Dsource=oari-Oar-v3.1-noncoding-gff -v
ant -Dsource=oari-Oar-v4.0-noncoding-gff -v
ant -Dsource=bovine-ensembl-gff -v
ant -Dsource=chir-ensembl-gff -v
ant -Dsource=oar-ensembl-gff -v
ant -Dsource=bovine-ogs-gff -v
ant -Dsource=bovine-umd3.1.1-qtl-gff -v
...
ant -Dsource=kegg -v
ant -Dsource=kegg-sec -v
ant -Dsource=kegg-ter -v

ant -Dsource=gpluse -v
ant -Dsource=bovine-umd3.1.1-gene-alias -v
ant -Dsource=bovine-umd3.1.1-transcript-alias -v
ant -Dsource=bovine-umd3.1.1-protein-alias -v
