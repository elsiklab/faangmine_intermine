...
<c:choose>
    ...
    <c:otherwise>
        ...
        <link type="text/css" rel="stylesheet" href="model/jstree/dist/themes/default/style.min.css"/>
        <script type="text/javascript" src="model/jstree/dist/jstree.min.js"></script>
        ...
        <script type="text/javascript">
            ...
            var genomeFeaturesCategory = "${WEB_PROPERTIES['genomicRegionSearch.genomeFeaturesCategory']}";
            var genomeFeaturesSources = "${WEB_PROPERTIES['genomicRegionSearch.genomeFeaturesSources']}".split(",").map(s => s.trim());
